...
class _UploadPageState extends State<UploadPage>
  ...
  getUserCurrentLocation() async {
    ...
    String completeAddressInfo =
        '${mPlaceMark.subThoroughfare} ${mPlaceMark.thoroughfare}, ${mPlaceMark.subLocality} ${mPlaceMark.locality}, ${mPlaceMark.subAdminArea} ${mPlaceMark.adminArea}, ${mPlaceMark.postalCode} ${mPlaceMark.countryName},';
    print(completeAddressInfo);
    String specificAddress =
        '${mPlaceMark.locality}, ${mPlaceMark.countryName}';
    locationTextEditingController.text = specificAddress;
    print(mPlaceMark.countryName);
  }
  ...
  controllUploadAndSave() async {
    ...
    String downloadUrl = await uploadPage(file);
  ...
  Future<String> uploadPage(mImageFile) async {
  ...
  displayUploadFormScreen() {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          FlatButton(
            onPressed: uploading ? null : () => controllUploadAndSave(),
            child: Text(
              'Share',
              style: TextStyle(
